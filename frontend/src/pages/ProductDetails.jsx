        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
          ...
          <div className="mt-10 px-2 sm:mt-16 sm:px-0 lg:mt-0">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
               <div className="flex items-center gap-3 text-sm text-gray-500"><Check className="w-5 h-5 text-green-500" /><span>Free shipping on orders over $100</span></div>
               <div className="flex items-center gap-3 text-sm text-gray-500"><Check className="w-5 h-5 text-green-500" /><span>30-day return policy</span></div>
            </div>
          </div>
        </div>
      </main>
